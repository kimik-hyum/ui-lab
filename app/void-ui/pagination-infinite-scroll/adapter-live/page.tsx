...
import { VirtuosoViewExample } from "../examples/virtuoso-view-example";

const PAGE_SIZE = 10;
const PAGE_PARAM_KEY = "p";
...
export default async function AdapterLivePage({ searchParams }: AdapterLivePageProps) {
  ...
  // Keep file dependency explicit so example source is tracked by Next.js build.
  await fs.access(path.join(process.cwd(), "app/void-ui/pagination-infinite-scroll/examples/virtuoso-view-example.tsx"));
